...
w = [0.] * D  # weight
n = [0.] * D  # number of times we've encountered a feature(n for compute adaptive learning rate)
...
def predict(test_file):
    ...
    cost = 0.0
    with open('submission_my_20.csv', 'w') as submission:
